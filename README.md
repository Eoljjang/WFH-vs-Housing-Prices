...
4. `city_growth_index_df.csv` = Calculates the change in housing prices for suburban vs. urban parts of a city, along with its WFH score.
    - Standardized to base 100.
    - Resets annually to base 100.
5. `FINAL_OUTPUTS.csv` / `.xlsx` = Final combined data demonstrating the net change in urban & suburban pricing, and donut gap.
